...
--create table called salary employyes with 3 feild name pay_by_quter which is an integer 
--with one diamension and 4 values and schedule which shuold be text feild with 2 diamension
...
--add row into salary_employye bill who 20,00 each quter and had 2 different schedule 
--records of meeting ,trainning and lunch ,sales call
